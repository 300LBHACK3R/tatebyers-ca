...
export function TateDesktop() {
  ...
  function playBootSound() {
    try {
      ...
      // Audio is optional. The site still works if the browser blocks it.
    }
  }
            ...
            {!booting ? (
              <>
                ...
                >
                  ...
                  <p>&gt; click XP mode for nostalgia mode</p>
  ...
  return (
    <div className="absolute right-5 top-5 z-20 hidden w-72 rotate-1 rounded-xl border border-yellow-600/30 bg-[#fff6a8] p-4 text-[#3a2f00] shadow-2xl lg:block">
      ...
      <p className="mt-3 text-sm leading-6">
        Welcome to Tate XP. Click desktop icons, open windows, close apps, check
        links, and try not to delete the internet.
      </p>
  ...
  return (
    <div className="absolute bottom-5 right-5 z-20 hidden w-80 rounded-2xl border border-green-400/20 bg-black/70 p-4 font-mono text-xs text-green-300 shadow-[0_0_40px_rgba(34,197,94,0.16)] backdrop-blur-md lg:block">
      ...
      <div className="space-y-2 text-green-500">
        ...
        <p>
          <span className="text-green-300">warning:</span> basic templates
          rejected
        </p>
      </div>
    </div>
    ...
    >
      ...
      <div
        className={cx(
          ...
          theme === "matrix"
            ? "border-green-400/15 bg-green-950/10"
      ...
      >
        <p>
          ...
          XP Mode has desktop icons, a custom Tate wallpaper, taskbar, start
          menu, closable windows, and a live system clock.
        </p>
      </div>
