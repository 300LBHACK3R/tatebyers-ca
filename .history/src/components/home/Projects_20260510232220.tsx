...
function getProjectCountByCategory(category: ProjectCategory) {
      ...
      <div className="container-premium relative z-10">
        <Reveal>
          <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
            ...
            <Link
              ...
              aria-label="View all Tate Byers projects"
            >
              View All Projects
            </Link>
          </div>
        ...
        <div className="mt-12 grid gap-6 lg:grid-cols-3">
          {projectGroups.map((group, index) => {
            const count = getProjectCountByCategory(group.category);
            const projectLabel = `${count} project${count === 1 ? "" : "s"} available`;
              ...
              <Reveal key={group.category} delayMs={index * 100}>
                <article className="card-premium edge-gold hover-lift group flex h-full flex-col overflow-hidden">
                  <div className="relative h-72 overflow-hidden bg-black">
                    <Image
                      src={group.image}
                      alt={`${group.title} project category`}
                      fill
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <div className="mt-auto pt-7">
                      <Link
                        ...
                        aria-label={`View ${group.title} projects`}
                      >
                        View Jobs
                      </Link>
                    </div>
